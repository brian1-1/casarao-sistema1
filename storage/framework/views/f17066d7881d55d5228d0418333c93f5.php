    ...
    <header class="topbar">
        ...
        <nav class="topbar-nav">
            ...
            <?php if($slug === 'gerente'): ?>
                ...
                <a href="<?php echo e(route('gerente.pasta-options.index')); ?>" class="<?php echo e(request()->routeIs('gerente.pasta-options.*') ? 'active' : ''); ?>"><i class="ti ti-adjustments"></i> Monte sua Massa</a>
            <?php endif; ?>
        </nav>
...
<?php /**PATH /home/brian/Documentos/projeto-oficina-restaurante/casarao-sistema1/resources/views/layouts/app.blade.php ENDPATH**/ ?>