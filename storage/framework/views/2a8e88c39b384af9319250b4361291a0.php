                    ...
                    <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!$item->isCancelled()): ?>
                            <div class="ready-item"><?php echo e($item->quantity); ?>x <?php echo e($item->product_name); ?>
                                ...
                                <?php if($item->isCustom()): ?><div class="ready-obs"><?php echo e($item->customization_label); ?></div><?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/brian/Documentos/restaurante/resources/views/garcom/index.blade.php ENDPATH**/ ?>