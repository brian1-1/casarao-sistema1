...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            ...
            <input type="text" name="serves" class="form-control" placeholder="Ex: Serve 1 pessoa / Serve 2 pessoas / Serve 3 unidades" value="<?php echo e(old('serves', $product->serves)); ?>">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group">
            <label class="form-check">
                <input type="checkbox" name="is_customizable" value="1" <?php if(old('is_customizable', $product->is_customizable)): echo 'checked'; endif; ?>>
            ...
            <div style="font-size:11px;color:var(--muted);margin-top:5px;">
                ...
                <a href="<?php echo e(route('gerente.pasta-options.index')); ?>" style="text-decoration:underline;">"Opções Monte sua Massa"</a>.
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/brian/Documentos/restaurante/resources/views/gerente/products/form.blade.php ENDPATH**/ ?>