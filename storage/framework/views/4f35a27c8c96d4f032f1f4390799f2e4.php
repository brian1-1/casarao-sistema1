...
<div class="container">
    ...
    <table class="table">
        <thead>
            <tr><th>Produto</th><th>Categoria</th><th>Preço</th><th>Disponível</th><th style="text-align:right;">Ações</th></tr>
        </thead>
        <tbody>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ubuntu/restaurante_laravel/resources/views/gerente/products/index.blade.php ENDPATH**/ ?>